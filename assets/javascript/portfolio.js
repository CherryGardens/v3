...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'youtube',
                link: 'https://www.youtube.com/cherrymc'
            },
		    {
                name: 'discord',
                link: 'https://dsc.gg/clients'
            },
		    {
                name: 'twitter',
                link: 'https://twitter.com/iCherriMC'
            },

            {
                name: 'reddit',
                link: 'https://www.reddit.com/user/CherriMC'
            },
            
            {
                name: 'github',
                link: 'https://github.com/iiCherry'
            },
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Hello user...", "Welcome to <span style='font-size: 14px; color: #800080;'>[cherri.gq]</span>..."], 30, function () {
                ...
                writeLine(["Taking you to the  <span style='font-size: 14px; color: #800080;'>correct page</span>", "Please wait..."], 30, 501, function () {
                    ...
                    writeLine(["<i style='color: #9403fc'>Done</i>"], 30, 500, function () {
