...
function update(datas) {
    ...
    if (datas.d.discord_status == "dnd") {
        ...
        document.getElementById("status").title = "Do Not Disturb";
        ...
        document.getElementById("status").title = "Idle";
    ...
    if (datas.d.spotify) {
        ...
        songtitle.innerHTML = "Currently not listening to anything";
    }
}
